...
namespace TrueCraft.Client.Graphics
{
    ...
    public sealed class Camera
    {
        ...
        /// <summary>
        /// Applies this camera to the specified shader program.
        /// </summary>
        /// <param name="program">The shader program to apply this camera to.</param>
        public void ApplyTo(ShaderProgram program)
        {
            if (_isDirty)
                Recalculate();
